...
namespace bbddAdo
{
    public partial class FormRellenarCancelarPedido : Form
    {
        private int parsedOrderID;

        public FormRellenarCancelarPedido()
        {
            InitializeComponent();
        }
        ...
        private bool IsOrderIDValid()
        {
            ...
            else
            {
                ...
                parsedOrderID = Int32.Parse(txtIdPedido.Text);
                return true;
            }
        }
                    ...
                    using (SqlCommand sqlCommand = new SqlCommand(sql, connection))
                    {
                        ...
                        try
                        {
                            ...
                            using (SqlDataReader dataReader = sqlCommand.ExecuteReader())
                            {
                                ...
                                this.dvgCostumerOrders.DataSource = dataTable;
