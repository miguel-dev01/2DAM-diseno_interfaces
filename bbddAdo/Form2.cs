...
namespace bbddAdo
{
    public partial class FormCuentaPedido : Form
    {
        private int parsedCustomerID;
        private int orderID;

        public FormCuentaPedido()
        {
            InitializeComponent();
        }
        ...
        private bool IsOrderDataValid()
        {
            ...
            if (txtIdentificadorCliente.Text == "")
            {
            ...
            if (IsCustomerNameValid())
            {
                ...
                using (SqlConnection connection = new SqlConnection(Properties.Settings.Default.connString))
                {
                    ...
                    using (SqlCommand sqlCommand = new SqlCommand("Sales.uspNewCustomer", connection))
                    {
                        ...
                        sqlCommand.Parameters["@CustomerName"].Value = txtNombreCliente.Text;
                        ...
                        try
                        {
                            ...
                            this.txtIdentificadorCliente.Text = Convert.ToString(parsedCustomerID);
                        }
                        catch
                        {
